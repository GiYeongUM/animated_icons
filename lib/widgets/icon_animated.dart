...
class IconAnimatedState extends State<IconAnimated>
  ...
  Widget build(BuildContext context) {
    ...
    return CustomPaint(
        foregroundPainter: AnimatedPathPainter(widget.progress, widget.color ?? theme.primaryColor, widget.strokeWidth, widget.iconType),
        child: SizedBox(
          width: widget.size,
          height: widget.size,
        ));
...
class AnimatedPathPainter extends CustomPainter {
  ...
  AnimatedPathPainter(this._animation, this._color, this.strokeWidth, this.iconType)
